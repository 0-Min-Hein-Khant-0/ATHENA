    ...
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          ...
          <a href="{{route('brand.create')}}" class="btn btn-info float-right mt-3">Add New</a>
          <table class="table mt-5 table-bordered dataTable" >
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{$row->name}}</td>
                <td>
                  <a href="{{route('brand.edit',$row->id)}}" class="btn btn-primary">Edit</a>
                  <a href="{{route('brand.show',$row->id)}}" class="btn btn-secondary">Show</a>
